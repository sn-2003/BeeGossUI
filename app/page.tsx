...
export default function Page() {
  ...
  return <main className="beegoss-shell home-shell">
    ...
    <button className="pass-banner" onClick={() => setShowPass(true)}><div><p className="eyebrow">NEW ON BEEGOSS</p><h2>BeeGoss Pass</h2><p>Six little reasons to make a plan today.</p><span>SEE MY PASS <ChevronRight /></span></div><div className="pass-banner-art"><Ticket /><Sparkles /></div></button>
    <section className="home-stats"><div><strong>11</strong><span>Planned<br />Activities</span></div><div><strong>0</strong><span>Joined<br />Circles</span></div><div><strong>0</strong><span>Events<br />Attended</span></div><div><strong>11</strong><span>Chat<br />Count</span></div></section>
